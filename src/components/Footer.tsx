        ...
        <div className="footer-grid">
          ...
          <div className="footer-links">
            <button
              onClick={() => {
                openModal('email');
                trackContactOpen('email', 'Footer Link');
              }}
              className="footer-meta-link"
              style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer', fontFamily: 'inherit', fontSize: 'inherit', color: 'inherit' }}
            >
            ...
            <a
              ...
              className="footer-meta-link"
              onClick={() => trackOutboundClick("Phone", "tel:+919634687270", "Footer Link")}
            >
            ...
            <a
              ...
              onClick={() => trackOutboundClick("LinkedIn", "https://www.linkedin.com/in/utkarshkala/", "Footer Link")}
            >
