...
import { trackOutboundClick, trackContactOpen } from "../analytics/analytics";
        ...
        <div className={`glass-card contact-card reveal active ${topContent ? "merged" : ""}`}>
          ...
          <div className="contact-links-grid">
            <a
              ...
              onClick={() => trackOutboundClick("Phone", "tel:+919634687270", "Contact CTA Section")}
            >
            ...
            <button
              onClick={() => {
                openModal('whatsapp');
                trackContactOpen('whatsapp', 'Contact CTA Section');
              }}
